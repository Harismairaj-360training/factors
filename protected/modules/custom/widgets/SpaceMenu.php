...
class SpaceMenu extends \humhub\widgets\BaseMenu
{
    ...
    public function init()
    {
        ...
        $link = str_replace("/s/","/topics/",$this->space->createUrl('/space/space/home'));
        ...
        $this->addItem(array(
            ...
            'group' => 'modules',
            'url' => $link,//$this->space->createUrl('/space/space/home'),
        ...
        $this->addItem(array(
            ...
            'group' => 'modules',
            'url' => $this->space->createUrl('/cfiles/browse'),
        ...
        $this->addItem(array(
            ...
            'group' => 'modules',
            'url' => $this->space->createUrl('//wiki/page'),
